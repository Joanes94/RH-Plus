...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* Ref / Titre */
        .doc-ref  { font-size: 14px; font-family: 'Times New Roman', Times, serif; font-style: italic; font-weight: 700; margin: 12px 0 6px; }
        .doc-title-box { text-align: center; margin: 10px 0 18px; }
        .doc-title-box h1 { display: inline-block; border: 2px solid #000; padding: 5px 28px; font-size: 15px; font-family: 'Times New Roman', Times, serif; font-weight: 700; text-transform: uppercase; letter-spacing: .05em; }
        /* Corps */
        .doc-body { font-size: 14px; font-family: 'Times New Roman', Times, serif; line-height: 2; text-align: justify; }
        .doc-body p { font-size: 14px; font-family: 'Times New Roman', Times, serif; margin-bottom: 12px; }
        .doc-body strong { font-weight: 700; }
        .indent { text-indent: 48px; }
        .doc-greeting { text-align: center; text-indent: 0; font-weight: 700; margin-bottom: 14px; font-size: 14px; }
        /* Destinataire */
        .doc-date-right { text-align: right; font-style: italic; font-size: 14px; font-family: 'Times New Roman', Times, serif; margin-bottom: 14px; }
        .doc-dest {
            text-align: right;
            padding-right: 30px;
            margin-bottom: 16px;
        ...
        .doc-dest .dest-a { font-weight: 700; line-height: 1; font-size: 14px; }
        .doc-dest .dest-name { font-weight: 700; font-size: 14px; }
        .doc-dest .dest-fn { font-style: italic; font-size: 14px; }
        /* Objet */
        .doc-object { font-weight: 700; font-size: 14px; font-family: 'Times New Roman', Times, serif; margin-bottom: 14px; }
        /* Signature */
