        ...
        <div class="input-wrapper select-wrapper filter-select" style="min-width:160px">
            <select name="centre_id">
                ...
                @foreach($centres as $c)
                    <option value="{{ $c->id }}" {{ ($filters['centre_id'] ?? '') == $c->id ? 'selected' : '' }}>{{ $c->nom }}</option>
                @endforeach
            </select>
        </div>
        @endif
            ...
            <tr>
                <td>
                    <div class="agent-cell">
                        ...
                        @else
                            <img src="{{ $s->avatar_url }}" alt="{{ $s->initiales }}" class="agent-photo">
                        @endif
                        <div>
                ...
                <td class="td-actions">
                    <a href="{{ route('stagiaires.show', $s) }}" class="icon-btn" title="Voir la fiche">
